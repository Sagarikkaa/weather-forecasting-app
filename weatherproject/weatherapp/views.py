...
def home(request):
    ...
    url = f'https://api.openweathermap.org/data/2.5/weather?q={city}&appid=a13972f12c751ce0381f190ace5440c9'
    
    # Parameters to request temperature in metric units (Celsius)
    PARAMS = {'units': 'metric'}

    # Your Google Custom Search API Key (keep it secret)
    API_KEY = 'AIzaSyDnaAgiyaWhVOb5w4Gx69L-5yCQZR2HQFM'

    # Your Google Custom Search Engine ID
    SEARCH_ENGINE_ID = 'f25dda5e7d5764126'
